...
describe('Product Controller', function() {
    ...
    it('server should start and should give 200 with access_token.', function( done ) {
        ...
        superagent.get('http://localhost:5000/api/product?access_token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiI1NzMzMjE1NGMwNzlmYzE5MGJhNGI5ODYiLCJleHAiOjE0NzAxMTk5NDU5MzksInJvbGUiOiJVc2VyIn0.GvYU-yxcIjV_VsmWnOkGGcAX_R503Kn8586wv22YrNQ').end(function(err, res) {
            if (err) { return done(err); }
